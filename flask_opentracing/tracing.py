...
class FlaskTracing(opentracing.Tracer):
    ...
    def _before_request_fn(self, attributes):
        ...
        span.set_baggage_item("http_x_forwarded_for", request.headers.get("HTTP_X_FORWARDED_FOR", ""))
        span.set_baggage_item("CONTENT_TYPE", request.headers.get("CONTENT_TYPE", ""))
